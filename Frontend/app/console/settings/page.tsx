    ...
    <div className="space-y-6 pb-20 lg:pb-0 max-w-4xl">
      <div className="flex items-center justify-between">
        ...
        {hasChanges && (
          <div className="flex items-center gap-3">
            <Button variant="outline" onClick={handleReset} className="bg-transparent" disabled={isSaving}>
      ...
      {hasChanges && (
        <div className="lg:hidden fixed bottom-20 left-4 right-4 flex gap-3">
          <Button variant="outline" className="flex-1 bg-transparent" onClick={handleReset} disabled={isSaving}>
            Reset
          </Button>
          <Button
