...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Music2, Loader2, Sparkles } from "lucide-react"
import Link from "next/link"
import Image from "next/image"
import { useRouter } from "next/navigation"

const DEMO_CREDENTIALS = {
  email: "demo@irenown.com",
  password: "demo123",
}
        ...
        <div className="mx-auto w-full max-w-sm lg:max-w-md">
          ...
          <div className="mb-6">
            <Button
              ...
              className="w-full h-12 bg-gradient-to-r from-primary/80 via-primary to-accent/80 text-primary-foreground hover:opacity-90 transition-all relative overflow-hidden group"
            >
            ...
            <p className="text-xs text-center text-muted-foreground mt-2">Instant access to explore all features</p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-background px-2 text-muted-foreground">Or sign in with your account</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <button type="button" onClick={fillDemoCredentials} className="text-xs text-primary hover:underline">
          ...
          <div className="mt-6 p-4 rounded-lg bg-card border border-border">
            ...
            <div className="space-y-1 text-xs font-mono">
              <p className="text-foreground">
                Email: <span className="text-primary">demo@irenown.com</span>
              </p>
              <p className="text-foreground">
                Password: <span className="text-primary">demo123</span>
              </p>
            </div>
          </div>
