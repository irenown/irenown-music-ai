      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          ...
          <AnimatedSection animation="slide-left">
            ...
            {/* Headline */}
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight lg:text-5xl xl:text-6xl text-balance">
            ...
            {/* Stats */}
            <div className="mt-10 sm:mt-12 flex flex-wrap gap-6 sm:gap-8">
              {[
                ...
                <AnimatedSection key={stat.label} delay={i * 100} animation="slide-up">
                  <div className="min-w-[80px]">
                    <p className="text-2xl sm:text-3xl font-bold text-irenown-gradient">{stat.value}</p>
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                      {["Pop", "R&B", "Hip-Hop", "Rock", "Electronic"].map((genre, i) => (
                        <span
                          key={genre}
                          className={`px-2.5 sm:px-3 py-1 rounded-full text-[10px] sm:text-xs font-medium transition-all cursor-pointer hover:scale-105 touch-target ${
                            i === 0
