            ...
            <AnimatedSection key={index} delay={index * 100}>
              <div className="relative group">
                ...
                <div className="relative rounded-2xl border border-border bg-card/50 p-6 transition-all duration-300 hover:border-primary/50 hover:glow-bronze hover:-translate-y-1">
                  {/* Step Number */}
                  <div className="absolute -top-3 -left-3 flex h-7 w-7 items-center justify-center rounded-full bg-primary text-xs font-bold text-primary-foreground glow-bronze">
                    {index + 1}
                  </div>
